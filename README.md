...
- [Recipes and dependencies](document.md#recipes-and-dependencies): header
  dependencies, `$<recipe>` references, and when edges record themselves.
...
- [`cook affected`](document.md#workspaces-and-directory-hopping): CI that
  builds and tests only the slice a PR touched.
