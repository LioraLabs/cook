...
export const SLUG_MAPPING: Record<string, string> = {
  ...
  'sec-8-7':     'steps.lua',
  'sec-8-7-1':   'steps.lua-delimitation',
  'sec-8-7-2':   'steps.lua-execution-phase',
  'sec-8-7-3':   'steps.lua-examples',
  'sec-8-8':     'steps.shell',
  'sec-8-9':     'steps.cross-recipe-member',
  ...
  'sec-24-4':    'lua.cook-probes',
  'sec-24-4-1':  'lua.cook-probes-get',
  'sec-24-4-2':  'lua.cook-probes-set',
  'sec-24-4-3':  'lua.cook-probes-scope',
  'sec-24-5':    'lua.cook-exports-imports',
  'sec-24-5-1':  'lua.cook-exports',
  'sec-24-5-2':  'lua.cook-imports',
